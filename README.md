...
5. Open DevTools → Rendering → Emulate CSS media: `color-gamut: p3` to preview wide-gamut swatches
...
- **ΔE CIE76**: perceptual color distance between the selected swatch and the comparison color.
